...
class InventoryPartnerBasedExpandedEvent(object):
    ...
    def __init__(self, ticket_types=None, id=None, name=None, description=None, short_description=None, starts_on=None, ends_on=None, ref_id=None, location=None, organization=None, event_uri=None, cover_image=None, timezone=None, refund_policy=None, restrictions=None):  # noqa: E501
